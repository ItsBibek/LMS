...
<head>
  ...
  <title>Admin Login - Academia Library</title>
  ...
  <div class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-sm text-slate-600">Admin Portal</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
          ...
          <p class="text-blue-100 text-sm mt-1">Enter your credentials to access the dashboard</p>
        </div>
        ...
        <div class="p-6">
          ...
          <form method="POST" action="{{ route('admin.login') }}" class="space-y-5">
            ...
            <button type="submit" class="w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all shadow-sm flex items-center justify-center">
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="mt-6 space-y-3">
            <div class="border-t border-slate-200 pt-4">
              <a href="{{ route('admin.password.request') }}" class="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center justify-center">
            ...
            <div class="border-t border-slate-200 pt-4 text-center">
              <p class="text-sm text-slate-600 mb-2">Are you a student?</p>
