...
<head>
  ...
  <title>Reset Password - Academia Library</title>
  ...
  <div class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-sm text-slate-600">Create a new secure password for your account</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-500 to-cyan-500 px-6 py-5">
          ...
          <p class="text-blue-50 text-sm mt-1">Please enter your new password below</p>
        </div>
