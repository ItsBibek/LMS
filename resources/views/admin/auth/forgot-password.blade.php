...
<head>
  ...
  <title>Admin Forgot Password - Academia Library</title>
  ...
  <div class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-900 mb-2">Admin Password Reset</h1>
        <p class="text-sm text-slate-600">Reset your admin account password</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
          ...
          <p class="text-blue-100 text-sm mt-1">Enter your admin email to receive a reset link</p>
        </div>
